...
public class BloodyEngiEntity extends Monster {
	...
	public BloodyEngiEntity(EntityType<BloodyEngiEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(AaeDimensionsModEntities.BLOODY_ENGI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
