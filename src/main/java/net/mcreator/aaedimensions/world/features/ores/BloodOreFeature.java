...
public class BloodOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("aae_dimensions:blood_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.NETHERRACK.defaultBlockState()), AaeDimensionsModBlocks.BLOOD_ORE.get().defaultBlockState())), 7));
